...
Playground 会验证单 Promotion 数据模型、typed meta、页面/时间/设备规则、区块/短代码/自动位置、管理员/订阅者/匿名 REST 边界、绑定 Promotion 的预览 nonce、预览权限、无 Placement/Options/自定义表以及显式卸载清理。真实编辑器与主题页面交互仍需在 Local 中做浏览器验收。
