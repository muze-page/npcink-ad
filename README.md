...
Playground 会验证单 Promotion 数据模型、typed meta、发布预检、页面/时间/设备规则、区块/短代码/自动位置、顶层区块与 Classic 段落锚点、管理员/订阅者/匿名 REST 边界、绑定 Promotion 的预览 nonce、时区与排期边界、无 Placement/Options/自定义表以及显式卸载清理。真实编辑器、列表快捷操作与主题页面交互仍需在 Local 中做浏览器验收。
